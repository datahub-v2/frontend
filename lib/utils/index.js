...
module.exports.getListOfDpWithReadme = async arrayOfPkgId => {
  const listOfPackages = await module.exports.getListOfDatapackages(arrayOfPkgId)
  const listOfReadme = await module.exports.getListOfReadme(arrayOfPkgId)
